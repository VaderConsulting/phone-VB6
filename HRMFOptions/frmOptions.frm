...
Begin VB.Form frmOptions 
   ...
   Caption         =   "HRMF to Microsoft Exchange Options"
   ClientHeight    =   4545
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5985
...
' General
Dim gAuto As Boolean
' Database
Dim gDb_Version As Integer
Dim gDbServerName As String, gDbName As String
Dim gDbUsername As String, gDbPassword As String, gDbOwner As String
Dim gModifiedSP As String, gUpdatesSP As String, gAdminUsers As String
' Exchange
Dim gMSXServer As String, gMSXOrganisation As String
Dim gMSXUsername As String, gMSXPassword As String
' Network
Dim gDomainName As String, gAdminGroupName As String

Private Sub cmdCancel_Click()
  Dim retval As Long
  retval = MsgBox("Quit and lose changes ?", vbQuestion + vbYesNo)
...
Private Sub cmdOK_Click()
  ...
  retval = MsgBox("Save and exit ?", vbQuestion + vbYesNo)
  If retval = vbYes Then
